...
/// @dev Reference: https://github.com/Uniswap/v4-periphery/blob/4d85e047e321d0c02134fec9044879c0cd00ea7d/src/libraries/Descriptor.sol
library Descriptor {
    ...
    function isSpecialCharacter(bytes1 b) internal pure returns (bool) {
        return b == '"' || b == "\u000c" || b == "\n" || b == "\r" || b == "\t";
    }
}
